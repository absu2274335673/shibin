...
//	public static final String MONGO_MQTT_DATABASE="dolina";
	...
	public static final String FIELD_MONGO_RESULT="result";
	public static final String FIELD_MONGO_TIME="time";
	public static final String FIELD_MONGO_EVENT="event";
	public static final String FIELD_MONGO_COUNTER="counter";
	public static final String FIELD_MONGO_DATA="data";
	public static final String FIELD_MONGO_PAGEID="pageid";
	public static final String FIELD_MONGO_APPIDS="appids";
	public static final String FIELD_MONGO_CLIENTID="clientid";
	public static final String FIELD_MONGO_TYPE="type";
	public static final String FIELD_MONGO_LOG="log";
	public static final String PHP_MQTT_URL=FileUtil.getProperty("service_url_prefix");
