...
public class JdbcUtils 
{
	// 饿汉式
		...
		static {  
		    try {  
		        ds.setUser(FileUtil.getProperty("mysql_user"));  
		        ds.setPassword(FileUtil.getProperty("mysql_password"));  
		        ds.setJdbcUrl(FileUtil.getProperty("mysql_jdbcurl")); 
//		        ds.setUser("root");  
//		        ds.setPassword("Grengine2016");  
//		        ds.setJdbcUrl("jdbc:mysql://mongo.100000q.com/dolina?useUnicode=true&characterEncoding=UTF8"); 
