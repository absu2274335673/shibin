...
//    private static final String CLIENTID = "_robot";
		...
		public void connectionLost(Throwable cause) {
  		...
  		public void deliveryComplete(IMqttDeliveryToken arg0) {
  			// TODO Auto-generated method stub
   			logger.info("deliveryComplete---------" + arg0.isComplete()+"messageid:"+arg0.getMessageId()+" time:"+System.currentTimeMillis());
  		}
			...
			if((offline==null)&&(!messagejudge.contains("robot")))
			{
				...
				else if(type.equals("text")||type.equals("image"))
				{
					...
					if(jo.has("tmpindex"))
					{
						...
						ConversationDao.updateClient(System.currentTimeMillis()/1000+"", convid);
	...
	public static void main(String[] args) throws MqttException {
		 ...
		 */
		signal.subscribe(Constant.TOPIC_MQTT_PROTOCOL, 0);
